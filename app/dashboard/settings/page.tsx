...
import { EmailIngestionSetup } from "@/components/settings/email-ingestion-setup";
...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <CustomDomainManager schoolId={profile.schoolId} school={school} />
